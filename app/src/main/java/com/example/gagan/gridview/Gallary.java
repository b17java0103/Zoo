...
public class Gallary extends AppCompatActivity implements View.OnClickListener {
    ...
    int thumb[] = { R.drawable.aa, R.drawable.bb,
            R.drawable.cc, R.drawable.oo, R.drawable.ee,R.drawable.ff,R.drawable.gg,R.drawable.hh,R.drawable.ii,
            R.drawable.jj,R.drawable.ll,R.drawable.mm,R.drawable.nn
    };
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(Gallary activity) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int pos = position;
            if (listItem == null) {
                listItem = layoutInflater.inflate(R.layout.single, null);
            }
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        findViewById(R.id.conatiner).getGlobalVisibleRect(finalBounds,globalOffset);
